...
<sub>\* 본 애플리케이션은 인터넷 강의를 참고하여 만들었으나, 필요하다고 판단되는 부분에서 원본 코드를 수정했습니다. 그리고 로컬 스토리지 저장, 주문 기능을 추가하였습니다. 또한 새롭게 디자인했습니다.</sub>
...
1. [아이템 상태 관리](#3-1-handle-context)
2. [아이템 추가](#3-2-add-item-to-cart)
3. [아이템 삭제](#3-3-remove-cart-item)
4. [아이템 출력](#3-4-show-cart-list)
...
[맨위로 이동하기](#-음식-배달-주문-앱-doorwink-토이-프로젝트)
